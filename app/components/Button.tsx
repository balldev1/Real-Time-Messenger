...
interface ButtonProps {
    ...
    fullWidth?: boolean;
    children?: React.ReactNode; // คุณสมบัติ children ที่จะส่งเข้ามา
    onClick?: () => void;
    secondary?: boolean;
    danger?: boolean;
    disabled?: boolean;
...
const Button: React.FC<ButtonProps> = ({ type, fullWidth, children, onClick, secondary, danger, disabled }) => {
    return (
        // focus-visible เมือคลิกปุ่ม ปุ่มจะขยาย
        //  cursor-default คือเมือdiisabled true นี่คือบริเวณที่ไม่สามารถคลิกได้
